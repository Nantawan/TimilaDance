...
<html>
<head>
<title>TDA | Admin Package Creation</title>
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Update Dance Lessons </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
...
<?php
$pid=intval($_GET['pid']);
$sql = "SELECT * from tbldlessons where PackageId=:pid";
$query = $dbh -> prepare($sql);
$query -> bindParam(':pid', $pid, PDO::PARAM_STR);
$query->execute();
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packageprice" id="packageprice" placeholder=" Package Price is NZD" value="<?php echo htmlentities($result->PackagePrice);?>" required>
									</div>
								</div>
