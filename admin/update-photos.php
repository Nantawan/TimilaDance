...
<?php
$pid=intval($_GET['pid']);
$sql = "SELECT * from tblphotos where PhotoId=:pid";
$query = $dbh -> prepare($sql);
$query -> bindParam(':pid', $pid, PDO::PARAM_STR);
$query->execute();
...
{	?>
							...
							<form class="form-horizontal" name="Photo" method="post" enctype="multipart/form-data">
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Photo Name</label>
									<div class="col-sm-8">
