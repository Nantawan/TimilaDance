...
<html>
<head>
<title>Aspire | Admin manage Issues</title>
...
<td><a href="javascript:void(0);" onClick="popUpWindow('http://localhost/aspire/admin/updateissue.php?iid=<?php echo ($result->id);?>');">View </a>
</td>
