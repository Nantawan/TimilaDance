...
<html>
<head>
<title>Timila Dance Academy | admin Dance Class</title>
...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Manage Dance Class</li>
            </ol>
				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2>Manage Dance Class</h2>
						...
						<tbody>
<?php $sql = "SELECT * from tbldlessons";
